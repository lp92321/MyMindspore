...
#include "ui_FlowCharWidget.h"
#include <QDebug>


FlowCharWidget::FlowCharWidget(QWidget *parent)
    : QMainWindow(parent)
    , ui(new Ui::FlowCharWidget)
{
    ui->setupUi(this);
...
*****************************************************************************
*/
int FlowCharWidget::RunPythonAPI()
{
    // 初始化
    Py_Initialize();
...
*****************************************************************************
*/
void FlowCharWidget::PrintTime(QString tip)
{
...
*****************************************************************************
*/
int FlowCharWidget::DrawLinechart(QLineSeries* lineSeries, QChartView* View)
{
...
*****************************************************************************
*/
void FlowCharWidget::on_tabWidget_tabBarClicked(int index)
{
    if(0 == index)
    {
        qDebug()<<"pag 设计器";
...
void FlowCharWidget::InitWindow()
{
    ...
    scene_ = new FlowchartScene(ui->graphicsView_widget_);
    // 中心窗口为widget_
